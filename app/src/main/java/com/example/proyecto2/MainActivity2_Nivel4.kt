...
class MainActivity2_Nivel4 : AppCompatActivity() {
    ...
    private fun numeroAleatorio() {
        val nombreImagenResta = "@drawable/resta"
        val nombreImagenSuma = "@drawable/adicion"
        if (score <= 39) {
            ...
            val intent = Intent(this, MainActivity2_Nivel5::class.java)
